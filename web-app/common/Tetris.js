 ...
 */
let Glob_render = null;
let held_tetoromino = null;
let can_hold = false;
Tetris.new_game = function (render) {
    Glob_render = render;
...
/**
 * Used to cache the current falling piece after the C key is pressed
 *  1. If the current fall cache area has no value and stores the current fall piece.
